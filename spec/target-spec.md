...
- **2026-09-16 reconciliation pass (issue #20)**: the six `[P]`-tagged §2
  ...
  **contradict** some part of it, most severely GBW (measured worst-case
  47% of target) and fall slew rate (measured worst-case under 9% of
...
sizing** at its measured worst case (8.45 MHz, 47% of the ≈16 MHz target);
